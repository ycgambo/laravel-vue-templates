...
<div class="mt-3">
    The BootstrapVue <a href="https://bootstrap-vue.js.org/docs/components/list-group">List Group</a> component is fully supported.'
</div>

<h1 class="mt-3">List Group <b-badge variant="primary" v-b-toggle.default>Source Code</b-badge></h1>
<div class="mt-3">
    <b-list-group>
        <b-list-group-item href="#">This is a default list group item</b-list-group-item>
        <b-list-group-item href="#" active>This is a active list group item</b-list-group-item>
