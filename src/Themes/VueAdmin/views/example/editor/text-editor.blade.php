...
<div class="mt-3">
    <text-editor autosave="id1" upload_url="/lvt/VueAdmin/example/img_upload"></text-editor>
</div>
...
<div class="mt-3">
    <text-editor autosave="id2" upload_url="/lvt/VueAdmin/example/img_upload">{!! <<<'DOC'
